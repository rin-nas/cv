...
1. Кто ведёт проектную документацию?
1. Есть ли в компании инспекция программного кода?
1. Есть ли в компании инспекция технических заданий?
1. Какие тестовые стенды есть? Пример: для разработчиков, ИФТ, ПСИ, НТ.
...
1. Какое ПО используется для документирования? Пример: Confluence
